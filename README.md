...
Neste projeto eu implementei várias funções para atender aos requisitos propostos e garantir que todas as funções passem nos testes unitários.
...
```bash
git clone git@github.com:apaulinhacarlos/trybe-fund-zoo-functions.git
```

Acesse o diretório do projeto com o comando `cd`:

```bash
cd trybe-fund-zoo-functions
```
